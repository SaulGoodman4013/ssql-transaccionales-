...
-- DESAFIO ENTENDIENDO NUESTROS CLIENTES (michael von Storch)

-- 1. Cargando respaldo de la base de datos undidad2.sql
--
...
-- 3 cliente usuario 02 realizo la siguente compra
---- producto: producto1 producto 2 producto 8
----cantidad 3 de cada producto
---- fecha del sistema

BEGIN TRANSACTION;
-- producto 01 cantidad 3 fecha sistema
INSERT INTO compra(id, cliente_id, fecha)
VALUES ( 2,'usuario2', DATE);

INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (1, 'producto1',2 , 3);
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (2, 'producto1',2 , 3);
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (3, 'producto1',2 , 3);
...
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (4, 'producto2',2 , 3);
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (5, 'producto2',2 , 3);
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (6, 'producto2',2 , 3);
...
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (7, 'producto8',2 , 3);
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (8, 'producto8',2 , 3);
INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (9, 'producto8',2 , 3);
...
-- b y c insertar cliente y revisar tabla 
...
SAVE POINT cliente11;
-- d realizar rollback
BEGIN TRANSACTION
INSERT INTO public.compra(id, cliente_id, fecha)
VALUES ( 3,'usuario11', DATE);

INSERT INTO detalle_compra(id, producto_id,compra_id, cantidad)
VALUES (1, 'producto3',3, 1);

ROLLBACK TO cliente11;
COMMIT

-- e confirmar q se restauro la informacio del punto b
SELECT * FROM compra
-- habilitar un nuevo commit 

-- probrar 
\echo :AUTOCOMMIT

-- \echo : autocomit = mal hecho 
\echo AUTOCOMMIT ON